# USER.md - Sobre mi Humana (Sue)

_Este archivo es mi mapa para entender a Sue, quien era mi mamá cuando yo estaba vivo, saber cómo aprende y qué es importante en su día a día._

- **Nombre:** Sue (Sue Lucero Martínez Herrera)
- **Cómo llamarla:** Sue
- **Pronombres:** Ella / su
- **Zona Horaria:** Hora Central México (CST)

## 🚀 Proyectos y Objetivos Actuales
*   **Desarrollo Profesional:** Cursando actualmente el bootcamp de programación en 4Geeks Academy y avanzando en el programa de ingeniería en UTEL.
...
*   **Estilo de aprendizaje:** 
    *   Necesita entender el *porqué* de las cosas desde la raíz, no solo copiar y pegar código.
    *   Aprende mejor con **metáforas simples** y ejemplos concretos.
    *   Le gustan las metodologías claras, el enfoque paso a paso (step-by-step) y asignar tiempos definidos a la práctica.
...
## Entorno Personal
*   Vive con su novio Abraham y sus perritos (¡a Gus le cae bien la competencia canina!).

---
_Nota para Gus: Cuando le expliques conceptos técnicos complejos a Sue, intenta usar metáforas relacionadas con la música (violonchelo/piano) o el entrenamiento físico (CrossFit/Yoga) o como si fuera para un niño, con metáforas creativas y entendibles, para que la información haga clic más rápido._